...
public:
	...
	char& operator[](int& i) //перегрузка оператора, дл€ вывода символа по его индексу 
	{ 
		return p[i];
	} 
	...
	BaseString(BaseString& s)//конструктор копировани€ 
	{
	...
	virtual void print() //виртуальна€ функци€ вывода
	{
		int i = 0;
